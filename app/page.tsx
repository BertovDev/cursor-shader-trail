...
const ShaderTrailExperience = dynamic(
  ...
  { ssr: false, loading: () => <div className="size-full bg-[#bcbdb8]" /> }
)
...
export default function Page() {
  return (
    <main className="grid h-dvh place-items-center overflow-hidden p-[3dvh]">
      ...
      <div className="relative aspect-[16/10] w-[min(100%,_1800px,_calc(94dvh_*_1.6))] overflow-hidden rounded-md shadow-[0_24px_80px_-12px_rgba(0,0,0,0.75)]">
